...
public class Node {
     ...
     * 
     * @param number
     *            the number of the node, basically the "name"
     * @param maxEdges
     *            the "M" value, this is required in order to create the array
     *            of node buddies
     */
     ...
     * 
     * @param nodeBuddy
     *            the identifier, ie. the number of the node the current node is
     *            connected to
     */
